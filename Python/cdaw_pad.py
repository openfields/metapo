...
def main():
    ...
    run_command("g.region",
                vector = "cdaw_65r@report")
# 414390  
    run_command("v.overlay",
                ainput = "cdaw_65r_padus@report",
                alayer = "1",
                atype = "auto",
                binput = "cdaw_65r_414390@report",
                blayer = "1",
                btype = "area",
                operator = "or",
                output = "cdaw_pad414390",
                olayer = "1,0,0",
                snap = 1e-8)
...
# 41424390
    run_command("v.overlay",
                ...
                alayer = "1",
                atype = "auto",
                binput = "cdaw_65r_41424390@report",
                blayer = "1",
                btype = "area",
                operator = "or",
                output = "cdaw_pad41424390",
                olayer = "1,0,0",
                snap = 1e-8)

    run_command("v.db.addcolumn",
                map = "cdaw_pad41424390",
                layer = "1",
                columns = "subarea double precision")
