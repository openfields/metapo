...
def main():
    ...
    run_command("g.region",
                vector = "gorjac_65r@report")
# 42  
    run_command("v.overlay",
                ainput = "gorjac_65r_pad@report",
                alayer = "1",
                atype = "auto",
                binput = "gorjac_65r_42@report",
                blayer = "1",
                btype = "area",
                operator = "or",
                output = "gorjac_pad42",
...
# 41424390
    run_command("v.overlay",
                ...
                alayer = "1",
                atype = "auto",
                binput = "gorjac_65r_41424390@report",
                blayer = "1",
                btype = "area",
                operator = "or",
                output = "gorjac_pad41424390",
                olayer = "1,0,0",
                snap = 1e-8)

    run_command("v.db.addcolumn",
                map = "gorjac_pad41424390",
                layer = "1",
                columns = "subarea double precision")
