...
def main():
    ...
    run_command("g.region",
                vector = "huach_65r@report")
# 43  
    run_command("v.overlay",
                ainput = "huach_65r_pad@report",
                alayer = "1",
                atype = "auto",
                binput = "huach_65r_43@report",
                blayer = "1",
                btype = "area",
                operator = "or",
                output = "huach_pad43",
